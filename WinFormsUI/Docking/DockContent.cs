...
namespace WeifenLuo.WinFormsUI.Docking
{
	public class DockContent : Form, IDockContent
	{
        ...
        public string m_SearchFilterTerm = "";
        public string SearchFilterTerm 
        { 
            get { return m_SearchFilterTerm; } 
            set 
            { 
                m_SearchFilterTerm = value; 
                if(NewSearchTerm != null)
                    NewSearchTerm(this, new EventArgs()); 
            } 
        }
        public event EventHandler NewSearchTerm;

        protected string GetSearchTerms(DataGridView dataGridView1)
        {
            if (dataGridView1.DataSource == null)
                return string.Empty;
            if (SearchFilterTerm.Length < 1)
                return string.Empty;
            ...
            {
                sb.Append(col.ColumnName + " LIKE @SearchTerm OR ");
            }
